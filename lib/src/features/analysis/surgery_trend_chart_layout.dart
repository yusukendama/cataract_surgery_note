...
final class SurgeryTrendChartLayout {
  ...
  factory SurgeryTrendChartLayout.calculate({
    ...
    final labelHeight = measureText('12/28').height;
    ...
    final plotTop = math.max(16.0, labelHeight / 2 + 8);
    final plotBottomInset = math.max(42.0, labelHeight + 20);
    final plotBottom = height - plotBottomInset;
    ...
    return SurgeryTrendChartLayout._(
      ...
      plotLeft: plotLeft,
      plotTop: plotTop,
      plotBottomInset: plotBottomInset,
      points: pointLayouts,
