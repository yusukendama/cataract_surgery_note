...
class TrendChartPainter extends CustomPainter {
  ...
  void _paintGrid(Canvas canvas) {
    final gridPaint = Paint()
      ...
      ..strokeWidth = 1;
    for (final tick in layout.durationAxis.ticks) {
      final ratio = layout.durationAxis.ratioFor(tick);
      final y =
          layout.plotBottom - (layout.plotBottom - layout.plotTop) * ratio;
      canvas.drawLine(
      ...
      _paintText(
        canvas,
        layout.durationAxis.labelFor(tick),
        Offset(layout.plotLeft - 8, y),
